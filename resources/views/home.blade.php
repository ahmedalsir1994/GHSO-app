...
<body>
    <nav class="fixed w-full top-0 z-50 bg-black/10 backdrop-blur-lg transition-colors duration-300 md:px-10 lg:px-10">
      ...
      <img class="h-10 w-auto" src="https://little-joy-studio.vercel.app/studio.png" width="999" height="999" alt="little joys studio" />
            ...
            <a href="/" class="flex items-center shrink-0">
                <img class="w-10" height="100" width="100" src="https://tailwindflex.com/images/logo.svg"
            ...
            <div class="hidden md:flex items-center md:gap-8 text-white">
                <a href="/" class="text-sm font-medium hover:text-purple-400 transition">Home</a>
                ...
                <a href="#contact"
                    class="cursor-pointer rounded-full border-2 py-2 px-6 border-white bg-white text-purple-900 hover:bg-purple-900 hover:text-white hover:shadow-lg transition duration-300 ease-in-out">
                    Contact Now
                </a>
            </div>
    ...
    <!-- Middle Section -->
    <section
        class="w-full flex items-center justify-center min-h-screen overflow-hidden bg-linear-to-b from-[#121212] to-purple-800">
        ...
        <div class="relative z-10 container mx-auto px-4 text-center text-white">
            <h1 class="mb-6 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl"
                ...
                Catching Life's <span class="relative whitespace-nowrap text-purple-400 dark:text-purple-400">
                    ...
                    <span class="relative">Beautiful</span>
                </span> Stories
            </h1>
            <p class="mx-auto mb-8 max-w-2xl text-lg">
                Professional photography services for weddings, events, portraits, and commercial shoots. Let us tell
            ...
            <div class="flex justify-center items-center mt-8" data-aos="fade-up" data-aos-delay="400">
                <a href="#pricing" rel="noopener noreferrer"
                    ...
                    <span class="relative z-10 pr-2">Book Now</span>
                </a>
            </div>
        </div>
        ...
        <div class="absolute sm:bottom-14 bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
            <a href="#about" class="cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-white" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24" stroke-width="2">
    ...
    <div class="mx-auto max-w-full px-4 py-4 sm:px-6 md:px-24 md:py-16 lg:px-8 lg:py-20 bg-black">
    ...
    <!-- Team Grid -->
    <div class=" max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-1 p-6 lg:grid-cols-4 gap-1 pt-8  ">

        @foreach($speakers as $speaker)
            <!-- Team Member 1 -->

            <div class=" group ">
                <div class="relative  overflow-hidden rounded-xl mb-4  place-items-center">
                    <img src="{{ $speaker->photo ? asset('images/' . $speaker->photo) : 'http://greenhydrogensummitoman.com/wp-content/uploads/2025/10/Mask-group.png' }}"
                        alt="{{ $speaker->name }}"
                        class="  max-w-[182.46px] max-h-[168px] object-cover object-center transform group-hover:scale-105 transition duration-300 ease-in-out">

                </div>
                <div class="text-center pb-6">
                    <h3 class="text-xl font-bold text-gray-800">{{ $speaker->name }}</h3>
                    <p class="text-indigo-600 font-medium">{{ $speaker->title }}</p>
                    <p class="text-gray-600 mt-2">{{ $speaker->organization }}</p>
                    <img src="{{ $speaker->logo ? asset('images/logos/' . $speaker->logo) : 'https://via.placeholder.com/100x50?text=No+Logo' }}"
                        alt="{{ $speaker->name }} Logo"
                        class="mx-auto {{ $speaker->getLogoHeightClass() }} object-contain pt-3">
                </div>
