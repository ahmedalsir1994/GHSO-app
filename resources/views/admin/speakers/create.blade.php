    ...
    <header class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="py-4">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mt-1">Create New Speaker</h1>
            </div>
        </div>
    </header>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('speakers.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex gap-4">
                <button type="submit"
                    class="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 rounded-lg transition font-medium">Create
                    Speaker</button>
