    ...
    <header class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="py-4">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mt-1">Edit Sponsor: {{ $sponsor->name }}</h1>
            </div>
        </div>
    </header>
        ...
        <form action="{{ route('sponsors.update', $sponsor) }}" method="POST"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="category" value="{{ old('category', $sponsor->category) }}"
            ...
            <div>
                ...
                <input type="text" name="logo" value="{{ old('logo', $sponsor->logo) }}"
            ...
            <div>
                ...
                <select name="language"
                    ...
                    <option value="en" {{ old('language', $sponsor->language) === 'en' ? 'selected' : '' }}>English
                    </option>
                    <option value="ar" {{ old('language', $sponsor->language) === 'ar' ? 'selected' : '' }}>Arabic
                    </option>
                </select>
            </div>
            ...
            <div class="flex gap-4">
                <button type="submit"
                    class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg transition font-medium">Update
                    Sponsor</button>
