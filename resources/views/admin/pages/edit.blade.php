    ...
    <header class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="py-4">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mt-1">Edit Page: {{ $page->title }}</h1>
            </div>
        </div>
    </header>
        ...
        <form action="{{ route('pages.update', $page) }}" method="POST"
            ...
            <div>
                ...
                <textarea name="content" rows="6"
                    class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500">{{ old('content', $page->content) }}</textarea>
            </div>
            ...
            <div class="flex gap-4">
                <button type="submit"
                    class="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg transition font-medium">Update
                    Page</button>
